Sovereign.window.UpdateAsianArtworks = function(config) {
    config = config || {};
    var check = Ext.getCmp('sovereign-window-asianartworks-update');
    check ? check.destroy(): '';
    ...
    Ext.applyIf(config,{
        ...
        ,baseParams: {
            action: 'mgr/asia/artworks/update'
        }
        ,id: this.ident
        ,fileUpload : true
        ,allowBlank: false
    ...
    Sovereign.window.UpdateAsianArtworks.superclass.constructor.call(this,config);
};
Ext.extend(Sovereign.window.UpdateAsianArtworks,MODx.Window);
Ext.reg('sovereign-window-asianartworks-update',Sovereign.window.UpdateAsianArtworks);
