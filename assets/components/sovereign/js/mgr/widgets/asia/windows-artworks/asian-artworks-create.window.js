Sovereign.window.CreateAsianArtworks = function(config) {
    config = config || {};
    var check = Ext.getCmp('sovereign-window-asianartworks-create');
    //check ? check.destroy(): '';
    if (check) {
        check.destroy();
    }
    ...
    Ext.applyIf(config,{
        ...
        ,baseParams: {
            action: 'mgr/asia/artworks/create'
        }
        ,id: this.ident
        ,fileUpload : true
        ,allowBlank: false
    ...
    Sovereign.window.CreateAsianArtworks.superclass.constructor.call(this,config);
};
Ext.extend(Sovereign.window.CreateAsianArtworks,MODx.Window);
Ext.reg('sovereign-window-asianartworks-create',Sovereign.window.CreateAsianArtworks);